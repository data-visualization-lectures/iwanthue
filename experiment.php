            ...
            <div class="row">
                <div class="span6">
                    ...
                    <div class="info">
                        ...
                        <p>
                            <b>HSV</b>（Hue / Saturation / Value）: Photoshop などで使われ、色相を他パラメータと分離できます。ただし色相によって明るさが異なるため（黄は明るく、青は暗い等）、知覚バイアスが大きくなります。
                        </p>
                        <p>
                            <b>HSL</b>（Hue / Saturation / Lightness）は HSV の変種で、同じくバイアスを含みます。
                        </p>
                        <p>
                            <b>L*a*b*</b>（Lightness* / a* / b*）は知覚に合わせて設計された空間です。Lightness* は黒→色→白のバイアスのない明度軸、a*・b* は色（およびグレー）を表します。存在しない色座標もあるため扱いは難しいものの、もっとも適切な結果を与えます。
                        </p>
                        <p>
                            <b>HCL</b>（Hue / Chroma / Lightness*）は L*a*b* から色相を独立させた変換で、HSL のバイアスを取り除いた形と見なせます。ただし L*a*b* 同様に存在しない色座標があり、凸ではないので計算上の扱いは難しいものの、結果を観察するには最適です。
                        </p>
                    </div>
                </div>
                <div class="span6">
