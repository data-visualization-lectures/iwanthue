    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="span3">
                <h3>設定</h3>
                <p>
                    <input id="nodescount" type="text" value="20" style="width:35px;" /> 色数
                </p>
                <p>
                    <input id="scatterplot" type="checkbox" /> 散布図スタイルで表示
                </p>
            </div>
            <div class="span3">
                <h3 class="infotitle">ユースケース A</h3>
                <div class="info">
                    <p>
            ...
            <div class="span3">
                <h3 class="infotitle">ユースケース B</h3>
                <div class="info">
                    <p>
        ...
        <div class="generators_zone row">
            <div class="span12">
                <div class="row">
                    <div class="span2 generator">
                        <h3>RGB Naïve</h3>
                        <button class="go" onclick='rgbNaive()'>実行</button>
                        <script>
                            function rgbNaive() {
                                var colors = [];
                    ...
                    <div class="span2 generator">
                        <h3>HSL Naïve</h3>
                        <button class="go" onclick='hslNaive()'>実行</button>
                        <script>
                            function hslNaive() {
                                var colors = [];
                                for (i = 0; i < parseInt($('#nodescount').val()); i++) {
                    ...
                    <div class="span2 generator">
                        <h3>HSV Naïve</h3>
                        <button class="go" onclick='hsvNaive()'>実行</button>
                        <script>
                            function hsvNaive() {
                                var colors = [];
                                for (i = 0; i < parseInt($('#nodescount').val()); i++) {
                    ...
                    <div class="span6">
                        <h3 class="infotitle">単純なジェネレーター</h3>
                        <div class="info">
                            <p>
                ...
                <div class="row">
                    <div class="span2 generator">
                        <h3>Lab Naïve</h3>
                        <button class="go" onclick='labNaive()'>実行</button>
                        <script>
                            function labNaive() {
                                var colors = [];
                                for (i = 0; i < parseInt($('#nodescount').val()); i++) {
                    ...
                    <div class="span2 generator">
                        <h3>Lab Pastel</h3>
                        <button class="go" onclick='labPastel()'>実行</button>
                        <script>
                            function labPastel() {
                                var colors = [];
                    ...
                    <div class="span2 generator">
                        <h3>Lab Pimp</h3>
                        <button class="go" onclick='labPimp()'>実行</button>
                        <script>
                            function labPimp() {
                                var colors = [];
                    ...
                    <div class="span6">
                        <h3 class="infotitle">Lab 系ジェネレーター</h3>
                        <div class="info">
                            <p>
                ...
                <div class="row">
                    <div class="span2 generator">
                        ...
                        <button class="go" onclick='rgbForceVector()'>実行</button>
                        <script>
                    ...
                    <div class="span2 generator">
                        ...
                        <button class="go" onclick='labForceVector()'>実行</button>
                        <script>
                    ...
                    <div class="span2 generator">
                        ...
                        <button class="go" onclick='labFancyForceVector()'>実行</button>
                        <script>
                    ...
                    <div class="span6 last">
                        ...
                        <div class="info">
                            <p>
                                The Force Vector strategy allows an even distribution of the colors in the space. It
                                still allows some coontrol on the produced palette ('Fancy').
                            </p>
                            <p>
                                Note that contrary to the "naïve" generators, the colors are generated all at the same
                                time (they depend on each other).
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="span2 generator">
                        <h3>RGB kMeans</h3>
                        <button class="go" onclick='rgbKMeans()'>実行</button>
                        <script>
                            function rgbKMeans() {
                                drawBackground();
                        ...
                        <p>
                            The k-Means algorithm clusterises the RGB color space. The resulting palette is constituted
                            of these k-Means (the "centers" of color clusters).
                        </p>
                    </div>
                    <div class="span2 generator">
                        <h3>Lab kMeans</h3>
                        <button class="go" onclick='labKMeans()'>実行</button>
                        <script>
                            function labKMeans() {
                                drawBackground();
                        ...
                        <p>
                            The k-Means algorithm clusterises the L*a*b* color space. The resulting palette is
                            constituted of these k-Means (the "centers" of color clusters).
                        </p>
                    </div>
                    <div class="span2 generator">
                        <h3>Lab Fancy kMeans</h3>
                        <button class="go" onclick='labFancyKMeans()'>実行</button>
                        <script>
                    ...
                    <div class="span6">
                        ...
                        <div class="info">
                            <p>
                                This strategy also allows an even distribution of the colors, but with less "extreme"
                                colors (the borders of the color space are not occupied). It allows more coordinated
                                colors on small palettes.
                            </p>
                            <p>
        ...
        <div class="row">
            <div class="span6">
                <h3 class="infotitle">色空間の性質</h3>
                <div class="info">
                    <p>
                        <b>RGB</b>（Red / Green / Blue）: ディスプレイやテレビの仕組みに一致するため計算しやすく、知覚とも比較的相性の良い空間です。
                    </p>
                    <p>
                        <b>HSV</b>（Hue / Saturation / Value）: Photoshop
                        などで使われ、色相を他パラメータと分離できます。ただし色相によって明るさが異なるため（黄は明るく、青は暗い等）、知覚バイアスが大きくなります。
                    </p>
                    <p>
                        <b>HSL</b>（Hue / Saturation / Lightness）は HSV の変種で、同じくバイアスを含みます。
                    </p>
                    <p>
                        <b>L*a*b*</b>（Lightness* / a* / b*）は知覚に合わせて設計された空間です。Lightness* は黒→色→白のバイアスのない明度軸、a*・b*
                        は色（およびグレー）を表します。存在しない色座標もあるため扱いは難しいものの、もっとも適切な結果を与えます。
                    </p>
                    <p>
                        <b>HCL</b>（Hue / Chroma / Lightness*）は L*a*b* から色相を独立させた変換で、HSL のバイアスを取り除いた形と見なせます。ただし L*a*b*
                        同様に存在しない色座標があり、凸ではないので計算上の扱いは難しいものの、結果を観察するには最適です。
                    </p>
                </div>
            </div>
            <div class="span6">
                <h3 class="infotitle">色空間の読み方</h3>
                <div class="info">
                    <p>
                        上部の四角は各色空間の投影図です（例: RGB は R×G、G×B、R×B の3投影）。どこに色が集まり、どこが疎かを把握できます。
                        例えば HSV では均等でも、RGB では偏るといった現象が観察できます。
                    </p>
                    <p>
                ...
                <h3 class="infotitle">ソート済みパレットの読み方</h3>
                <div class="info">
                    <p>
