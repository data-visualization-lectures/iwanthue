...
<body>
    ...
    <div class="container">
        ...
        <div class="row textblock">
            ...
            <div class="span6">
                <ul class="inlinePalette">
                    <li style="background-color: #451228">
                        <p>#451228</p>
                    </li>
                    <li style="background-color: #13D907">
                        <p>#13D907</p>
                    </li>
                    <li style="background-color: #F9F4FC">
                        <p>#F9F4FC</p>
                    </li>
                    <li style="background-color: #41039B">
                        <p>#41039B</p>
                    </li>
                    <li style="background-color: #47544E">
                        <p>#47544E</p>
                    </li>
                    <li style="background-color: #122B53">
                        <p>#122B53</p>
                    </li>
                    <li style="background-color: #59DA63">
                        <p>#59DA63</p>
                    </li>
                    <li style="background-color: #7B1386">
                        <p>#7B1386</p>
                    </li>
                    <li style="background-color: #4B381C">
                        <p>#4B381C</p>
                    </li>
                    <li style="background-color: #CDBCD0">
                        <p>#CDBCD0</p>
                    </li>
                    <li style="background-color: #EAEAEA">
                        <p>#EAEAEA</p>
                    </li>
                    <li style="background-color: #B1CDE4">
                        <p>#B1CDE4</p>
                    </li>
                </ul>
            </div>
        ...
        <div class="row textblock">
            ...
            <div class="span6">
                <ul class="inlinePalette">
                    <li style="background-color: #DBA714">
                        <p>#DBA714</p>
                    </li>
                    <li style="background-color: #391FEA">
                        <p>#391FEA</p>
                    </li>
                    <li style="background-color: #46385C">
                        <p>#46385C</p>
                    </li>
                    <li style="background-color: #E5154B">
                        <p>#E5154B</p>
                    </li>
                    <li style="background-color: #3E9A71">
                        <p>#3E9A71</p>
                    </li>
                    <li style="background-color: #3495F5">
                        <p>#3495F5</p>
                    </li>
                    <li style="background-color: #57510C">
                        <p>#57510C</p>
                    </li>
                    <li style="background-color: #D9B182">
                        <p>#D9B182</p>
                    </li>
                    <li style="background-color: #8625B8">
                        <p>#8625B8</p>
                    </li>
                    <li style="background-color: #83CA5D">
                        <p>#83CA5D</p>
                    </li>
                    <li style="background-color: #6252A1">
                        <p>#6252A1</p>
                    </li>
                    <li style="background-color: #DB5E3A">
                        <p>#DB5E3A</p>
                    </li>
                </ul>
            </div>
        ...
        <div class="row textblock">
            <div class="span6">
                <p>
                    <a href="http://en.wikipedia.org/wiki/Lab_color_space">CIE L*a*b*</a>
                    色空間は人が知覚できる色をほぼ網羅し、知覚的に一様になるよう設計されています。
        ...
        <div class="row textblock">
            ...
            <div class="span4">
                <br />
                <ul class="inlinePalette">
                    <li style="background-color: #A09C04">
                        <p>#A09C04</p>
                    </li>
                    <li style="background-color: #F161FE">
                        <p>#F161FE</p>
                    </li>
                    <li style="background-color: #27B0CC">
                        <p>#27B0CC</p>
                    </li>
                    <li style="background-color: #FA231D">
                        <p>#FA231D</p>
                    </li>
                    <li style="background-color: #04103B">
                        <p>#04103B</p>
                    </li>
                    <li style="background-color: #FA918F">
                        <p>#FA918F</p>
                    </li>
                    <li style="background-color: #1A5A18">
                        <p>#1A5A18</p>
                    </li>
                    <li style="background-color: #963700">
                        <p>#963700</p>
                    </li>
                </ul>
            </div>
        ...
        <div class="row textblock">
            <div class="span5">
                ...
                <p>
                    ...
                    ここでは <a href="http://en.wikipedia.org/wiki/Kmeans">k-Means</a> アルゴリズムを用い、色空間を <em>k</em>
                    個の領域に分割し、それぞれの中心点をパレットとして採用します。
                </p>
                <p>
            ...
            <div class="span4">
                <br />
                <ul class="inlinePalette">
                    <li style="background-color: #BE3CBE">
                        <p>#BE3CBE</p>
                    </li>
                    <li style="background-color: #3CBE3C">
                        <p>#3CBE3C</p>
                    </li>
                    <li style="background-color: #3C3C3C">
                        <p>#3C3C3C</p>
                    </li>
                    <li style="background-color: #BE3C3C">
                        <p>#BE3C3C</p>
                    </li>
                    <li style="background-color: #3CBEBE">
                        <p>#3CBEBE</p>
                    </li>
                    <li style="background-color: #BEBE3C">
                        <p>#BEBE3C</p>
                    </li>
                    <li style="background-color: #3C3CBE">
                        <p>#3C3CBE</p>
                    </li>
        ...
        <div class="row textblock">
            ...
            <div class="span4">
                <br />
                <ul class="inlinePalette">
                    <li style="background-color: #C7743B">
                        <p>#C7743B</p>
                    </li>
                    <li style="background-color: #9B4DCA">
                        <p>#9B4DCA</p>
                    </li>
                    <li style="background-color: #93C4A2">
                        <p>#93C4A2</p>
                    </li>
                    <li style="background-color: #513363">
                        <p>#513363</p>
                    </li>
                    <li style="background-color: #94C64D">
                        <p>#94C64D</p>
                    </li>
                    <li style="background-color: #514C34">
                        <p>#514C34</p>
                    </li>
                    <li style="background-color: #C45271">
                        <p>#C45271</p>
                    </li>
                    <li style="background-color: #969CC6">
                        <p>#969CC6</p>
                    </li>
                </ul>
            </div>
        ...
        <div class="row textblock">
            <div class="span6">
                <h3>HCL 色空間</h3>
                <p>
                    RGB が画面が色を<em>生成する</em>仕組みに、CIE L*a*b* が私たちが色を<em>知覚する</em>仕組みに対応しているなら、HCL
                    は色をどう<em>考える</em>かに対応しています。
            ...
            <div class="span6">
                <div class="alert alert-info">
                    <p>
                        この巧妙な手法は Gregor Aisch によって（再）発見されました。<a
                            href="http://vis4.net/blog/posts/avoid-equidistant-hsv-colors/">このブログ記事</a>で詳しく説明されています。
                        ぜひ一読してください。なお、私がこのツールで多用した <a href="https://github.com/gka/chroma.js">Chroma.js</a> も彼が開発したものです。
                    </p>
                    <p>
                        <strong><em>HCL</em> という用語についての注意</strong>: この色空間は当初、CSL（chroma / saturation /
                        lightness）と呼ばれていました。
