	...
	<div class="container">
		...
		<div class="splash-unit row">
			...
			<div class="span5">
				...
				<a class="btn btn-primary" href="index.php"><i class="icon-white icon-arrow-right"></i> Current
					version</a>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="span12">
				...
				<p>
					Choose how much colors you want, choose a preset or use custom settings, and generate your palette.
					The palette is generated by clustering a color space and ordering the resulting colors.
				</p>
			</div>
		</div>
		<div class="row">
			<div class="span4">
				...
				<h3>Settings</h3>
				<p>
					<i>These settings apply on the HCL color space, as described in the Chroma.js library. Note that the
						CIE L*a*b* color space is nevertheless used for the computations.</i>
				</p>
				<p>
				...
				<h3>How it works</h3>
				<p>
					The color above are obtained by a regular sampling of the CIE L*a*b* color space. Not filtered, the
					1782 colors represent the full range of colors that the human eye is able to see.
				</p>
				<p>
					The settings allow you to restrain the color space. Each of these 1782 are tested to know if they
					fit to some criteria. This criteria is expressed in the HCL color space popularized by Chroma.js.
					<br />
					The HCL color space fits better the human vision than HSV or HSL, but is easy to understand,
					contrary to L*a*b* (since Hue is a separate parameter).
				</p>
				<p>
					We use an algorithm (k-Means or Force Vector) to place colors, in this restrained color space, in a
					way that they are the most distant possible - "distant" in the sense of the distance in the L*a*b*
					color space.
				</p>
				<p>
			...
			<div class="span6">
				...
				<br />
				<i>NB: requires <a href="https://github.com/gka/chroma.js">Chroma.js</a> and our <a
						href="js/libs/chroma.palette-gen.js" target="_blank">chroma.palette-gen.js</a></i>
